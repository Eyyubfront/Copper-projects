...
<Box  className="ivans"  sx={{backgroundColor:"#E6E8E7"}} border="1px solid" height="150px" padding="30px" width="800px">
<Stack className="personsdsa" alignItems="center"  flexDirection="row" gap="20px">
<Box  >
<img style={{width:"66px",height:"66px"}} src={jon} alt="" />
</Box>

<Stack flexDirection="column" gap="10px">
<Typography width="300px">
Axşamınız xeyir, İvan İvanov
</Typography>
<Typography>
Xoş alış-veriş!
</Typography>
...
<Box>
    <PersonIcon sx={{color:"white",fontSize:"130px"}} />
</Box>
...
<Box border="1px solid" width='450px' padding="40px" className="basketbox2" flexDirection="column" gap="20px">
...
<Box>
<AddShoppingCartIcon className="shopsd" sx={{fontSize:"140px",color:"#A1A1A1",marginTop:"-210px",marginLeft:'100px'}}/>
</Box>
